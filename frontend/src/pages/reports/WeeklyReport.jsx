  ...
  const generateWeeklyPDF =
    async () => {
      ...
      try {
        ...
        console.log(
          "WEEKLY REPORT OIL PROVIDER:",
          oilProviderName
        );


        console.log(
          "WEEKLY REPORT OIL PROVIDER LOGO SOURCE:",
          pumpLogoUrl
        );
        ...
        console.log(
          "WEEKLY REPORT OIL PROVIDER LOGO LOADED:",
          Boolean(
            pumpLogoData
          )
        );
        ...
        const fileName =
          `${safePumpName}_Weekly_Report_${from}_to_${to}.pdf`;
        ...
        toast.success(
          "Weekly report PDF exported successfully",
          {
            id:
              "weekly-report-pdf",
          }
        ...
        console.error(
          "WEEKLY REPORT PDF ERROR:",
          error
        );

        toast.error(
          "Unable to export weekly report PDF",
          {
            id:
              "weekly-report-pdf",
          }
